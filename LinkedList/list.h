...
typedef struct Node_s {
    void * item;
    int nodeIndex;         //Used when deleting a node and storing index of next available.
    struct Node_s * next;
    struct Node_s * prev;
} Node;
...
typedef struct {
    bool beforeList;
    bool beyondList;
    unsigned int nodeCount;          //Keeps track of how many nodes assigned to the list.
    int listIndex;          //Used when deleting a list and storing index of next available.
    Node * head;            //Keeps track of the head of the list.
    Node * tail;            //Keeps track of the tail of the list
    Node * currentItem;     //Keeps track of the current node pointer.
} List;
